...
extension CalendarView {
    ...
    func configureCell(cell: JTACDayCell?, date: Date, cellState: CellState, calendarMode: CalendarMode, calendarModelList: [CalendarModel]) {
        guard let cell = cell as? CalendarDayCell else { return }
        handleCellColor(cell: cell, cellState: cellState)
        handleCellSelection(cell: cell, cellState: cellState)
        handleCellEvents(cell: cell, date: date, cellState: cellState, calendarMode: calendarMode, calendarModelList: calendarModelList)
    }
    ...
    func handleCellEvents(cell: CalendarDayCell, date: Date, cellState: CellState, calendarMode: CalendarMode, calendarModelList: [CalendarModel]) {
