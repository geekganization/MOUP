...
final class CalendarHeaderView: UIView {
    ...
    private let toggleSwitch = BetterSegmentedControl()
...
private extension CalendarHeaderView {
    ...
    func setHierarchy() {
        self.addSubviews(yearMonthLabel, toggleSwitch, configButton)
    }
    ...
    func setConstraints() {
        ...
        toggleSwitch.snp.makeConstraints {
            $0.trailing.equalTo(configButton.snp.leading).offset(-2)
            $0.centerY.equalToSuperview()
            $0.width.equalTo(90)
            $0.height.equalTo(25)
        }
